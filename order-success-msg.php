...
<head>
  ...
  <title><?php echo SITE_TITLE ?> || Success</title>
...
<img class="thanku" src="images/right_tick.png" style="height: 80px;" />
                <br>
                <br>
                <h3>
                    <b class="booking_con"> Thank you</b>, your order is completed.
                </h3>

                <h4>Your order ID is : <b><?php if(isset($ordr_id)){echo $ordr_id;}?></b><h4>
