...
<head> 
        ...
        <!-- App title -->
        <title><?php echo ADMIN_TITLE;?> | Terms & Conditions</title> 
        <!--Morris Chart CSS -->
...
<div id="myToast" class="toast-popup"></div>
           ...
           <?php include "include/sidebar.php";?>
            ...
            <div class="content-page">
                ...
                <div class="content">
					...
					if(isset($cid)){
						$total=0;
						$cid=$_GET['cid'];
						$row=mysqli_query($con,"select * from 	`terms_conditions` where cid='1'");
						$result=mysqli_fetch_assoc($row);
					}
					?>
                       <div class="row" id="edit-down" style="display:<?php if($total!=0){ echo 'none';}?>">					
						<div class="col-sm-8 col-sm-offset-2">
						<form id="form1" role="form" method="POST" enctype="multipart/form-data" action="control/terms_conditions.php">
                                <div class="card-box">
					...
					<div class="col-xs-12 col-md-7">
							<div class="card-box table-responsive">
								<h4 class="m-t-0 header-title"><b>Terms & Conditions</b></h4>
								...
								<table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
									...
									<tbody>
										<?php
											$i=0;                     
											$res = mysqli_query($con,"SELECT * FROM `terms_conditions`");
			...
			<div style="position:relative;top:20px;"><a style="background-color:red; padding:5px; border:1px solid red; color:#fff" href="term-condition.php?cid=<?php echo $x["cid"];?>">Update </a>
			</div>
			</td>
			</tr>
			<?php 
...
if($(this).prop("checked") == true){
	...
	var v = $(this).attr('datano');
	 ...
	 $.ajax({
		type: "GET",
		data: "update="+v+"&status="+status+"&table=terms_conditions",
		url: "update.php",
...
<script>
			  $("#del").click(function(){
				...
				$.ajax({
				  type:"post",
				  url:"delete.php",
				  data:data+"&table=terms_conditions",
