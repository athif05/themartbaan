...
<html> 
	<head>  
		...
		<!-- App title -->        
		<title><?php echo ADMIN_TITLE;?> || Clients</title>        <!-- Switchery css -->
												...
												<table id="datatable" class="table table-striped table-bordered no-footer" role="grid" aria-describedby="datatable_info">									
													<thead>
														<tr role="row">	
															...
															<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 15%;">First Name</th>

															<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 15%;">Mobile</th>

															<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 35%;">E-mail</th>
															
															<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 15%;">Password</th>

															<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 13%;">Action</th>
													...
													<tr role="row" class="odd">
														...
														<td style="width: 7%;">	
															<div class="checkbox checkbox-danger checkbox-circle">
																<input id="checkbox-12" type="checkbox" name="check[]" value="<?php echo $clientLine["cid"]; ?>">
														...
														<td style="width: 15%;">
															...
															<a data-toggle="tooltip" data-placement="top" title="Edit" href="edittext.php?id=<?php echo $clientLine["cid"];?>&table=clients&field=fname" onclick="window.open(this.href,'UPDATE','width=900,height=700'); return false">
														...
														<td style="width: 15%;">
															...
															<a data-toggle="tooltip" data-placement="top" title="Edit" href="edittext.php?id=<?php echo $clientLine["cid"];?>&table=clients&field=phone" onclick="window.open(this.href,'UPDATE','width=900,height=700'); return false">
																<span style="width:50px;height:50px;">
																	<i class="fa fa-pencil-square-o" aria-hidden="true" style="color:green;font-size:14px;"></i>
																</span>
															</a>
														...
														<td style="width: 15%;">
															<?php echo $clientLine['password']; ?>
														</td>

														<td style="width: 13%;">
															<?php
																$str1 = '';
																if($clientLine['status'] == '1'){
																	$str1 = 'checked';
																}
															?>

<input class="status" dataid="<?php echo $clientLine['cid']?>" type="checkbox" data-plugin="switchery" data-color="#3aa99e"  <?php echo $str1;?>/>&nbsp;&nbsp;
														</td>
														</form>
													</tr>							
													<?php }  ?>
