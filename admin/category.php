					...
					<div class="container">  
						...
						<div class="row">
							<div class="col-xs-12 col-md-5">							
								<div class="card-box">							
									<div class="row">	
										<form method="POST" action="control/category.php" enctype="multipart/form-data" >							
											<div class="col-xs-12 col-sm-12">	
												...
												<h4 class="header-title m-t-0">Add Category</h4>	
											...
											<div class="col-md-12">
												<table id="datatable" class="table table-striped table-bordered no-footer" role="grid" aria-describedby="datatable_info">									
													...
													<tr role="row" class="odd">
														...
														<td style="width: 30%;">
															<!-- <a href="#" id="img-url" style="" name="control/<?php //echo $result['imageName'];?>"> -->
