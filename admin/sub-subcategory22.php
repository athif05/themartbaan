					...
					<div class="container">  
						<div class="row">	
							<div class="col-xs-12">		
								<div class="page-title-box">   
									<h4 class="page-title">Add Sub-subCategory</h4>
						...
						<div class="row">
							<div class="col-xs-12 col-md-5">							
								<div class="card-box">							
									<div class="row">	
										<form method="POST" action="control/sub-subcategory.php" enctype="multipart/form-data" >							
											<div class="col-xs-12 col-sm-12">	
												...
												<h4 class="header-title m-t-0">Add Sub-subCategory</h4>	
												...
												<div class="p-20">												
													...
													<div class="form-group">	
														...
														<select class="form-control" required name="subParentCategory" id="subParentCategory">
															<option value="">
																-- Select Category --
															</option>
														</select>
							...
							<div class="col-xs-12 col-md-7">						
								<div class="card-box table-responsive">		
									<h4 class="m-t-0 header-title"><b>Sub-subCategory Table</b></h4>								
												...
												<table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">									
													<thead>
														<tr role="row">	
															...
															<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 18%;">Sub-Parent</th>

															<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 20%;">Parent</th>
													...
													<tbody id="pbody">
													<?php
													$data = mysqli_query($con,"SELECT * from `tbl_category` where  parentCategory!=0 and subParentCategory!=0 order by cid asc");
													$i=1;
													while($result = mysqli_fetch_array($data)) {

														$parentCategoryName=_categoryNameFunction($result['parentCategory']);
														$subparentCategoryName=_categoryNameFunction($result['subParentCategory']);
													?>									
													<tr role="row" class="odd">
														...
														<td style="width: 18%;">
															...
															<?php echo $subparentCategoryName; ?>&nbsp;&nbsp;
															<a data-toggle="tooltip" data-placement="top" title="Edit" href="edit-subparent-category.php?id=<?php echo $result["cid"];?>&table=tbl_category&field=subParentCategory&cate_id=<?php echo $result['parentCategory'];?>&sub_cate_id=<?php echo $result['subParentCategory'];?>" onclick="window.open(this.href,'UPDATE','width=900,height=700'); return false">
																<span style="width:50px;height:50px;">
																	<i class="fa fa-pencil-square-o" aria-hidden="true" style="color:green;font-size:14px;"></i>
																</span>
															</a>
														...
														<td style="width: 20%;">
															...
															<a data-toggle="tooltip" data-placement="top" title="Edit" href="edit-mainparent-category.php?id=<?php echo $result["cid"];?>&table=tbl_category&cate_id=<?php echo $result['parentCategory'];?>&sub_cate_id=<?php echo $result['subParentCategory'];?>" onclick="window.open(this.href,'UPDATE','width=900,height=700'); return false">
																<span style="width:50px;height:50px;">
																	<i class="fa fa-pencil-square-o" aria-hidden="true" style="color:green;font-size:14px;"></i>
																</span>
															</a>
...
<input class="status" dataid="<?php echo $result['cid']?>" type="checkbox" data-plugin="switchery" data-color="#3aa99e"  <?php echo $str1;?>/>&nbsp;&nbsp;
		...
		<script>
			/*update category status, start here*/
			...
			/*update category status, end here*/

			/*category ajax, start here*/
			$('#parentCategory').on('change', function() {
				var cnt_ID = $("#parentCategory").val();
