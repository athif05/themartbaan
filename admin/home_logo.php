...
<head>
	...
	<meta name="author" content="Coderthemes"><!-- App Favicon --><link rel="shortcut icon" href="assets/images/favicon.png"><!-- App title --><title><?php echo ADMIN_TITLE;?> || Logo</title><!-- Switchery css -->
<link href="assets/plugins/switchery/switchery.min.css" rel="stylesheet" /><!-- App CSS --><link href="assets/css/style.css" rel="stylesheet" type="text/css" /><!-- Jquery filer css -->
...
<h4 class="m-t-0 header-title"><b>Default Logo</b></h4>
...
<?php
$i=1;                     
$res = mysqli_query($con,"SELECT * FROM logo where cid='1'");
...
<div class="p-20">
<form method="POST" action="control/home_logo.php" enctype="multipart/form-data">
...
*Logo should be in JPEG/PNG/GIF format <br> *Size should be less than 500 KB
...
<div id="img-hide"><img alt="Logo Display Here" id="test"  style="display:none;height:90px;width:90px;"/></div>
...
$.ajax({
type: "GET",
data: "update="+v+"&status="+status+"&table=logo",
url: "update.php",
...
<script>
$("#del").click(function(){
var d = confirm("Are you sure you want to delete this logo ?")
