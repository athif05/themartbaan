...
<div id="myToast" class="toast-popup"></div>
           ...
           <?php include "include/sidebar.php";?>
            ...
            <div class="content-page">
                ...
                <div class="content">
					...
					if(isset($cid)){
						$total=0;
						$cid=$_GET['cid'];
						$row=mysqli_query($con,"select * from `privacy_policy` where cid='1'");
						$result=mysqli_fetch_assoc($row);
					}
					?>
                       <div class="row" id="edit-down" style="display:<?php if($total!=0){ echo 'none';}?>">					
						<div class="col-sm-8 col-sm-offset-2">
						<form id="form1" role="form" method="POST" enctype="multipart/form-data" action="control/privacy_policy.php">
                                <div class="card-box">
							...
							<div class="card-box table-responsive">
								...
								<table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
									...
									<tbody>
										<?php
											$i=0;                     
											$res = mysqli_query($con,"SELECT * FROM `privacy_policy`");
			...
			<div style="position:relative;top:20px;"><a style="background-color:red; padding:5px; border:1px solid red; color:#fff" href="privacy_policy.php?cid=<?php echo $x["cid"];?>">Update </a>
			</div>
			</td>
			</tr>
			<?php 
...
if($(this).prop("checked") == true){
	...
	var v = $(this).attr('datano');
	 ...
	 $.ajax({
		type: "GET",
		data: "update="+v+"&status="+status+"&table=privacy_policy",
		url: "update.php",
...
<script>
			  $("#del").click(function(){
				...
				$.ajax({
				  type:"post",
				  url:"delete.php",
				  data:data+"&table=privacy_policy",
