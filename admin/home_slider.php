...
<meta charset="utf-8">     
   ...
   <!-- App title -->        <title><?php echo ADMIN_TITLE;?> || Slider</title>        <!-- Switchery css -->  
...
$(document).ready(function(){
		...
		if(s==0 && t==0){
			...
			<div class="row">	
			<?php 
			$result=mysqli_query($con,"select count(*) as total from slider");
			...
			<div class="card-box">							
			<div class="row">	
			<form method="POST" action="control/home_slider.php" enctype="multipart/form-data" style="width: 100%;" >							
			...
			<div class="p-20">												
				...
				<div class="col-sm-12">
					<div style="float: left; width: 49%;">
						...
						<input type="text" name="text3"class="form-control" required="" placeholder="Type something" data-parsley-id="34">												
						</div>
					</div>
...
<!-- end row -->  
			...
			<h4 class="m-t-0 header-title"><b>Slider Table</b></h4>								
			...
			<thead>
										...
										<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 340px;">Text1</th>											<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 340px;">Text2</th>											<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 150px;">Priority</th>											<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 150px;">Update</th>										</tr>								
										</thead>									
										<tbody>	
										<?php                         
									...
									mysqli_query($con,"UPDATE `slider` SET `priority`='$priority' WHERE `cid`= '$cid'  ");
									...
									$data = mysqli_query($con,"select * from slider order by priority asc");
									$i=1;
									...
									<a href="control/editimage.php?id=<?php echo $result["cid"];?>&table=slider&field=image" onclick="window.open(this.href,'UPDATE','width=900,height=700'); return false"><span style="width:50px;height:50px;">
									...
									<a data-toggle="tooltip" data-placement="top" title="Edit" href="edittext.php?id=<?php echo $result["cid"];?>&table=slider&field=text1" onclick="window.open(this.href,'UPDATE','width=900,height=700'); return false">
									...
									<td><?php echo $result['text2']; ?>&nbsp;&nbsp;<a data-toggle="tooltip"                                                    data-placement="top" title="Edit" href="edittext.php?id=<?php echo $result["cid"];?>&table=slider&field=text2" onclick="window.open(this.href,'UPDATE','width=900,height=700'); return false"><span style="width:50px;height:50px;">
									<i class="fa fa-pencil-square-o" aria-hidden="true" style="color:green;font-size:14px;"></i><span></span></span></a></td>
