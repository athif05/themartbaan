...
<html> 
	<head>  
		...
		<!-- App title -->        
		<title><?php echo ADMIN_TITLE;?> | Brand</title>        <!-- Switchery css -->
					...
					<div class="container">  
						...
						<div class="row">
							<div class="col-xs-12 col-md-5">							
								<div class="card-box">							
									<div class="row">	
										<form method="POST" action="control/brand.php" enctype="multipart/form-data" >							
											<div class="col-xs-12 col-sm-12">	
												...
												<div style="background-color:#ededed; color:#000; padding:5px; border-radius:0px; font-size:12px;border:1px solid #ff5d48; margin-bottom:10px">
													* Brand Image should be in JPEG/PNG format <br> 
													*Size should be less than 500 KB
												</div>
												<h4 class="header-title m-t-0">Add Brand</h4>	
												...
												<table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">									
													<thead>
														<tr role="row">	
															...
															<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 30%;">Image</th>
													...
													<tbody id="pbody">
													<?php
													$data = mysqli_query($con,"SELECT * from `tbl_brand` order by cid asc");
													$i=1;
													...
													<tr role="row" class="odd">
														...
														<td style="width: 30%;">
															...
															&nbsp;&nbsp;
															<a href="control/editimage.php?id=<?php echo $result["cid"];?>&table=tbl_brand&field=imageName" onclick="window.open(this.href,'UPDATE','width=900,height=700'); return false">
														...
														<td style="width: 30%;">
															...
															<a data-toggle="tooltip" data-placement="top" title="Edit" href="edittext.php?id=<?php echo $result["cid"];?>&table=tbl_brand&field=name" onclick="window.open(this.href,'UPDATE','width=900,height=700'); return false">
																<span style="width:50px;height:50px;">
																	<i class="fa fa-pencil-square-o" aria-hidden="true" style="color:green;font-size:14px;"></i>
																</span>
															</a>
