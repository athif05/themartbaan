...
if(isset($_POST['submit']))
{
  ...
  if ($uploadOk == 0) {
      ...
      if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
		    ...
		    mysqli_query($con,"INSERT INTO `tbl_category` (name,parentCategory,imageName,status,post_date,ipAddress,last_updated) VALUES ('$name','$parentCategory','$target_file','1','$save_date','$ipAddress','$curDateTime')"); 
      } else{
