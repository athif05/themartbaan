...
<meta charset="utf-8">     
   ...
   <!-- App title -->        <title><?php echo ADMIN_TITLE;?> || Listing Sidebar Slider</title>        <!-- Switchery css -->  
   ...
   (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){          (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),          m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)          })(window,document,'script','../../www.google-analytics.com/analytics.js','ga');          ga('create', 'UA-79190402-1', 'auto');          ga('send', 'pageview');     
			...
			<h4 class="page-title">Listing Sidebar Slider Images</h4>                                   
...
$(document).ready(function(){
		...
		if(s==0 && t==0){
			...
			<div class="row">	
			<?php 
			$result=mysqli_query($con,"select count(*) as total from listing_sidebar_slider");
			...
			<div class="card-box">							
			<div class="row">	
			<form method="POST" action="control/listing_sidebar_slider.php" enctype="multipart/form-data" style="width: 100%;" >							
			...
			* Slider Image should be in JPEG/PNG format <br> *Size should be less than 1 MB
			...
			<h4 class="header-title m-t-0">Add Listing Sidebar Slider</h4>	
...
<!-- end row -->  
			...
			<h4 class="m-t-0 header-title"><b>Liting Sidebar Slider Table</b></h4>								
			...
			<thead>
									...
									mysqli_query($con,"UPDATE `listing_sidebar_slider` SET `priority`='$priority' WHERE `cid`= '$cid'  ");
									...
									$data = mysqli_query($con,"select * from listing_sidebar_slider order by priority asc");
									$i=1;
									...
									<a href="control/editimage.php?id=<?php echo $result["cid"];?>&table=listing_sidebar_slider&field=image" onclick="window.open(this.href,'UPDATE','width=900,height=700'); return false"><span style="width:50px;height:50px;">
...
type:"post",
url:"delete.php",
data:data+"&table=listing_sidebar_slider",
...
<script>
			...
			$('#pbody').on('change','.status', function(){
				...
				$.ajax({
					...
					data: 'as='+as+'&id='+id+'&type=listing_sidebar_slider',
