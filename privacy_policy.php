...
$policySql=mysqli_query($con, "select * from privacy_policy");
$policyLine=mysqli_fetch_assoc($policySql);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="page-title">
          <h2><?php echo $policyLine['heading']; ?></h2>
        </div>
        </div>
      </div>
    </div>
...
<?php echo $policyLine['description']; ?>
